...
export function PersonSearchForm({
  ...
  return (
    <div
      ...
      onMouseEnter={disabled ? () => onHoverChange?.(true) : undefined}
      onMouseLeave={disabled ? () => onHoverChange?.(false) : undefined}
    >
      <Card className={disabled ? "opacity-50 pointer-events-none select-none" : ""}>
        <CardHeader>
          <CardTitle>Search Criteria</CardTitle>
          <CardDescription>
            Fill in one or more fields to trigger search. All provided fields will be used to narrow the results.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="flex gap-3 flex-wrap">
              <Button type="submit" disabled={loading || disabled || !hasAnyField}>
                {loading ? (
                  <>
